...
Week‑4 notes list household & place nouns: *krāsns, plīts, pirts, telts, klēts, kūts*, cities from *pils* (Daugavpils), and nature set *klints, zivs, govs, zoss, smiltis, debesis*; plural‑only *durvis, brokastis* are also used.
