...
- Distinguish pairs like **mainīt** (transitive: _ko?_ + Acc.) vs **mainīties** (intransitive: _kas?_ + Nom.).
...
- Reinforce case governance: _ko?_ (Acc.), _ar ko?_, _par ko?_ cues appear in items.
...
_Package generated: 2025-11-02_
