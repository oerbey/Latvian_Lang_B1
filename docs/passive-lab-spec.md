...
- Show an **active** sentence; player builds the **passive** by picking: _tense_ (tagadne/pagātne/nākotne), _patient_ (subject in Nom.), and the **correct participle ending**.
- Two modes:
...
```json
{
  ...
  "alsoAccept": [
    "Jautājumi ir sagatavoti.",
    "Jautājumi bija sagatavoti.",
    "Jautājumi būs sagatavoti."
  ],
