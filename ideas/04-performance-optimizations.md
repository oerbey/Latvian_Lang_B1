...
class DirtyRegionManager {
  ...
  getDirtyRegion() {
    ...
    const region = this.dirtyRects.reduce((acc, rect) => ({
...
<head>
  ...
  <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.13.1/fonts/bootstrap-icons.woff2" as="font" type="font/woff2" crossorigin>
  ...
  <style>
    @font-face {
      ...
      font-display: swap;
      src: url('https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.13.1/fonts/bootstrap-icons.woff2') format('woff2');
    }
  </style>
</head>
```
