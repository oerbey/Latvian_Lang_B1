...
- data/endings-builder/offline.js -> embedded declension tables/items
...
I18N_DIR = ROOT / "i18n"
DATA_DIR = ROOT / "data"
ENDINGS_DIR = ROOT / "data" / "endings-builder"
...
def main():
    ...
    endings_data = {
        "tables": load_json(ENDINGS_DIR / "tables.json"),
        "items": load_json(ENDINGS_DIR / "items.json"),
    }
    ...
    endings_path = ENDINGS_DIR / "offline.js"
    endings_payload = (
        "// Auto-generated by scripts/build_week1_offline.py. Do not edit manually.\n"
