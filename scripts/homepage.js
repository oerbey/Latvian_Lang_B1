...
const games = [
  ...
  },
  {
    ...
    icon: '≋',
    desc: 'Choose between near-lookalike Latvian forms by meaning and sentence context.',
    tag: 'Nuance',
    meta: ['Focus: forms', '6–9 min', 'Context'],
    accent: '#0d9488',
    art: 'linear-gradient(135deg, rgba(37, 99, 235, 0.24), rgba(13, 148, 136, 0.24)), url("assets/previews/verbs_preview.png")',
    category: 'vocabulary',
  },
  {
  ...
  {
    title: 'Form Factory v2',
    href: 'form-factory-v2.html',
    icon: '⚡',
    desc: 'Mobile-first cloze rounds for divdabji — fill the gap with -dams, -dama, -damies, or -damās.',
    tag: 'Cloze',
    meta: ['Focus: participles', '4–6 min', 'Mobile-first'],
    accent: '#2f6b5b',
    art: 'linear-gradient(135deg, rgba(47, 107, 91, 0.28), rgba(37, 99, 235, 0.2)), url("assets/previews/endings_preview.png")',
    category: 'conjugation',
  },
  {
    title: 'Form Factory v3',
    href: 'form-factory-v3.html',
    icon: 'Ⅲ',
    desc: 'Modern tap-first divdabju rounds with deck focus, instant feedback, and summary stats.',
    tag: 'Mobile',
    meta: ['Focus: participles', '4–6 min', 'Tap-first'],
    accent: '#0f766e',
    art: 'linear-gradient(135deg, rgba(15, 118, 110, 0.28), rgba(224, 100, 79, 0.2)), url("assets/previews/endings_preview.png")',
    category: 'conjugation',
  },
  {
  ...
  },
  {
    ...
    icon: '⚔️',
    desc: 'Explore 6 worlds of Latvian grammar in an RPG adventure. Battle words, earn XP, level up!',
    tag: 'Adventure',
